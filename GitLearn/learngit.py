...
# 其他版本控制系统的分支
# 克隆一份全新的目录以同样拥有5个分支来说，SVN是同时复制5个版本的文件，
...
# 切换分支
# git checkout 分支名
# Git 2.23后可以使用新命令git switch 分支名来切换分支
...
# 匿名分支
# 切换到一个没有名字的分支，在匿名分支中所作的所有操作，所有提交都将会丢弃掉
# 所以可以用匿名分支来做一些实验
# git switch -c new-branch-name 来创建一个新分支来保存更改
#   git switch - 舍弃操作回到master
